        ...
        raw_logs = [
            {
                ...
                "operatorName": "System",
                "detail": "Initial archive imported from seeded clinical data.",
...
PATIENT_RECORDS: List[Dict[str, object]] = [
    {
        ...
        "summary": "帕金森病中期患者，近期需要重点关注步态波动、用药依从性与复诊节奏。",
        "dataSupport": "high",
        "contactLogs": [
            {
    ...
    },
    {
        ...
        "summary": "阿尔茨海默病晚期患者，需重点关注照护支持、家属协同和连续随访。",
        "dataSupport": "high",
        "contactLogs": [
            {
    ...
    },
    {
        ...
        "summary": "阿尔茨海默病中期患者，当前照护支持较稳定，需继续跟踪情绪与睡眠。",
        "dataSupport": "high",
        "contactLogs": [],
        "events": [
    ...
    },
    {
        ...
        "summary": "糖尿病中期患者，血糖管理和血压监测需要持续跟进。",
        "dataSupport": "high",
        "contactLogs": [
            {
    ...
    },
    {
        ...
        "summary": "糖尿病患者，近期资料仍需补齐，建议完善用药史、检查报告和随访记录。",
        "dataSupport": "low",
        "contactLogs": [],
        "events": [
    ...
    },
    {
        ...
        "summary": "帕金森病晚期患者，需重点处理跌倒风险、用药依从性和家庭照护安排。",
        "dataSupport": "high",
        "contactLogs": [],
        "events": [
    ...
    return [
        {
            ...
            "summary": "该相似病例来自同病种历史轨迹，用于辅助解释当前患者的病程走势。",
...
def _build_advice(record: Dict[str, object]) -> List[str]:
    ...
    if support == "low":
        ...
        advice.append("可结合预测结果、相似病例和本次面诊信息进行复核。")
    return advice
