INSERT INTO patients (
  ...
  ('PID0025', '周建华', '男', 72, 'https://api.dicebear.com/9.x/initials/svg?seed=%E5%91%A8%E5%BB%BA%E5%8D%8E', '13800010025', '周敏', '女儿', '13800020025', 'Parkinson''s', 'Mid', '高风险', '2025-03-18', '帕金森病中期患者，重点关注步态波动、依从性与复诊节奏。', 'high'),
  ('PID0078', '刘淑琴', '女', 79, 'https://api.dicebear.com/9.x/initials/svg?seed=%E5%88%98%E6%B7%91%E7%90%B4', '13800010078', '陈立', '儿子', '13800020078', 'Alzheimer''s', 'Late', '高风险', '2025-03-16', '阿尔茨海默病晚期患者，需重点关注照护支持和连续随访。', 'high'),
  ('PID0217', '张美兰', '女', 75, 'https://api.dicebear.com/9.x/initials/svg?seed=%E5%BC%A0%E7%BE%8E%E5%85%B0', '13800010217', '李芳', '女儿', '13800020217', 'Alzheimer''s', 'Mid', '中风险', '2025-03-12', '阿尔茨海默病中期患者，建议继续跟踪情绪与睡眠。', 'high'),
  ('PID0191', '王海峰', '男', 61, 'https://api.dicebear.com/9.x/initials/svg?seed=%E7%8E%8B%E6%B5%B7%E5%B3%B0', '13800010191', '王琳', '配偶', '13800020191', 'Diabetes', 'Mid', '中风险', '2025-03-20', '糖尿病中期患者，需要持续跟进血糖与血压监测。', 'high'),
  ('PID0313', '陈素梅', '女', 57, 'https://api.dicebear.com/9.x/initials/svg?seed=%E9%99%88%E7%B4%A0%E6%A2%85', '13800010313', '赵辉', '配偶', '13800020313', 'Diabetes', 'Mid', '中风险', '2025-03-08', '糖尿病患者，近期资料仍需补齐，建议完善用药史和检查记录。', 'low'),
  ('PID0144', '马惠春', '男', 70, 'https://api.dicebear.com/9.x/initials/svg?seed=%E9%A9%AC%E6%83%A0%E6%98%A5', '13800010144', '马强', '儿子', '13800020144', 'Parkinson''s', 'Late', '高风险', '2025-03-06', '帕金森病晚期患者，需要重点处理跌倒风险和用药依从性。', 'high')
...
INSERT INTO patient_contact_logs (
  ...
  ('clog-0025-01', 'PID0025', '2025-03-19 10:00:00', 'phone', 'patient', 'reached', 'demo_clinic', '林医生', '电话随访已接通，患者反馈步态波动较前一周略有增加，已提醒按时复诊。', '2025-03-26'),
  ('clog-0078-01', 'PID0078', '2025-03-17 15:20:00', 'family', 'emergency_contact', 'scheduled', 'demo_specialist', '赵医生', '与家属沟通后确认本周内陪同复诊，并补充夜间照护观察记录。', '2025-03-24'),
  ('clog-0191-01', 'PID0191', '2025-03-21 09:10:00', 'phone', 'patient', 'reached', 'demo_clinic', '林医生', '电话回访已接通，提醒继续监测血糖和血压，并准备下次门诊检查结果。', '2025-03-28')
ON DUPLICATE KEY UPDATE
  note = VALUES(note),
